...
pub fn encrypt_with_key(plaintext: &str, key: &str) -> String {
    ...
    let ciphertext = cipher
        .expect(&format!("Failed to load cipher for encrypt_with_key. plaintext={} key={}", plaintext, key))
...
pub fn decrypt_with_key(ciphertext: &str, key: &str) -> String {
    ...
    let plaintext = cipher
        .expect(&format!("Failed to load cipher for decrypt_with_key. ciphertext={} key={}", ciphertext, key))
